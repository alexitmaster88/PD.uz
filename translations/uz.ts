const uz = {
  ...
  telc_page_ticket_title: "TELC German darajalari",
  telc_page_ticket_subtitle: "A1-A2 dan B2 gacha TELC German yo‘lingizni tanlang.",
  telc_page_stat_1_title: "Til darajalari",
  telc_page_stat_1_value: "A1–B2",
  telc_page_stat_2_title: "Bugun boshlang",
  telc_page_stat_2_value: "Tez ro‘yxat",
  telc_page_level_a1_a2: "A1-A2",
  telc_page_level_a1_a2_description: "Kunlik muloqot uchun boshlang‘ichdan elementargacha nemis tili.",
  telc_page_level_a2_b1: "A2-B1",
  telc_page_level_a2_b1_description: "Harakat va ish uchun elementar va o‘rta nemis tili.",
  telc_page_level_b1: "B1",
  telc_page_level_b1_description: "O‘qish va ish uchun mustaqil nemis tili.",
  telc_page_level_b2: "B2",
  telc_page_level_b2_description: "Kasbiy va akademik maqsadlar uchun ilg‘or nemis tili.",
  telc_step_1_title: "Darajangizni tanlang",
  telc_step_1_description: "Maqsadlaringiz va hozirgi darajangizga mos keladigan TELC German imtihon darajasini tanlang.",
  telc_step_2_title: "Hujjatlaringizni yuboring",
  telc_step_2_description: "Ro‘yxat ma’lumotlaringiz va imtihon sanasini yuboring, biz joyingizni bron qilamiz.",
  telc_step_3_title: "Tasdiqni oling",
  telc_step_3_description: "Biz imtihon sanasini tasdiqlaymiz va zarur ma’lumotlar hamda materiallarni taqdim etamiz.",
  telc_faq_section_label: "FAQ",
  telc_faq_title: "TELC ro‘yxatiga oid savollar",
  telc_faq_description: "TELC German imtihoniga ro‘yxatdan o‘tish bo‘yicha eng tez-tez so‘raladigan savollarga javoblar.",
  telc_faq_q_1: "TELC German imtihoni nima?",
  telc_faq_a_1: "TELC — bu xalqaro miqyosda tan olingan nemis tili imtihoni bo‘lib, A1-A2 dan B2 gacha darajalar kundalik muloqot, ta’lim va ish uchun mos.",
  telc_faq_q_2: "Qaysi darajalarga ro‘yxatdan o‘tishim mumkin?",
  telc_faq_a_2: "Siz TELC German imtihonlariga A1-A2 dan B2 gacha ro‘yxatdan o‘tishingiz mumkin. Biz hozirgi darajangizga mos darajani tanlashda yordam beramiz.",
  telc_faq_q_3: "Imtihonni qanday bron qilaman?",
  telc_faq_a_3: "Ro‘yxat so‘rovingizni to‘ldiring, imtihon sanasini tanlang va biz TELC hamkorlari bilan rasmiy bron qilish jarayonini amalga oshiramiz.",
  telc_faq_q_4: "Natijalarni qachon olaman?",
  telc_faq_a_4: "TELC natijalari odatda imtihondan bir necha hafta so‘ng tayyor bo‘ladi. Biz natijalar kelishi bilan darhol sizga xabar qilamiz.",
  telc_need_help_label: "Yordam kerakmi?",
  telc_need_help_title: "TELC bo‘yicha savollaringiz qolib ketdimi?",
  telc_need_help_cta: "Jamoamizga murojaat qiling",
  telc_booking_title: "TELC German imtihonini bron qilish",
  telc_booking_subtitle: "PROFI DEUTSCH bilan O‘zbekistonda TELC A1-A2, A2-B1, B1 va B2 darajalarini tanlang.",
  telc_booking_description: "O‘z yoqimli shaharingizni va imtihon darajasini tanlang, so‘ngra jamoamizga bron qilish so‘rovi yuboring.",
  telc_booking_location_label: "Istalgan joyni tanlang",
  telc_booking_level_label: "Imtihon darajasini tanlang",
  telc_booking_submit: "Bron qilish so‘rovi yuborish",
  telc_booking_note: "Jamoamiz siz bilan imtihon sanasi va ro‘yxatga olish tafsilotlarini tasdiqlash uchun bog‘lanadi.",
  telc_booking_level_a1: "A1",
  telc_booking_exam_section_title: "TELC imtihonlari variantlari",
  telc_booking_exam_section_subtitle: "Joriy nemis til darajangizga mos keladigan sertifikat imtihonini tanlang.",
  ...
  telc_booking_exam_desc_a1: "Boshlang‘ich uchun kundalik muloqotga yo‘naltirilgan imtihon.",
  telc_booking_exam_desc_a2: "Amaliy vaziyatlar va oddiy suhbatlar uchun elementar imtihon.",
  telc_booking_exam_desc_b1: "Ish va o‘qish uchun mustaqil nemis tilidan foydalanish imtihoni.",
  telc_booking_exam_desc_b2: "Professional muloqot va murakkab nutq uchun yuqori darajadagi imtihon.",
  telc_booking_feature_official: "Rasmiy TELC imtihonini ro‘yxatga olish",
  telc_booking_feature_support: "Tayyorlov yordami va imtihon materiallari",
  telc_booking_feature_personalized: "Muvaffaqiyat uchun shaxsiy tayyorlov",
  telc_booking_feature_fast_confirmation: "Imtihon sanasini tez tasdiqlash",
  telc_booking_cities_title: "TELC imtihonlari uchun mavjud joylar",
  telc_booking_cities_description: "O‘zbekistondagi markazlarimizdan birini tanlang — mahalliy qo‘llab-quvvatlash va ro‘yxatga olish yordamiga ega bo‘ling.",
  telc_booking_city_description: "TELC uchun mahalliy yordam, ekspert maslahatlari va ro‘yxatga olish xizmatlari.",
  telc_booking_city_support_badge: "Imtihon yordami",
  telc_booking_city_badge: "TELC joyi",
  telc_booking_city_tashkent: "Toshkent",
  telc_booking_city_samarkand: "Samarqand",
  telc_booking_city_fergana: "Farg‘ona",
  telc_booking_city_bukhara: "Buxoro",
  telc_booking_city_khorezm: "Xorazm",
  telc_booking_city_qashqadaryo: "Qashqadaryo",
  ...
  telc_booking_tab_information: "Ma’lumot",
  telc_booking_tab_preparation: "Tayyorlov kursi",
  telc_booking_tab_faq: "FAQ",
  telc_booking_info_b1_b2_title: "B1 va B2 darajasida nimalar qila olasiz?",
  telc_booking_info_b1_b2_text: "B1 darajasida siz taniqli mavzular va shaxsiy qiziqish sohalarida oddiy va izchil tarzda o‘z fikringizni ifodalashingiz mumkin. B2 darajasida siz ham aniq, ham umumiy mavzular bo‘yicha murakkab matnlarning asosiy g‘oyalarini tushunasiz. Siz shuningdek, o‘zingizni erkin va ravon ifoda eta olasiz.",
  telc_booking_info_exam_structure_title: "Imtihon qanday tuzilgan?",
  telc_booking_info_exam_structure_intro: "TELC German B1-B2 imtihoni yozma va og‘zaki bo‘limlardan iborat. Yozma imtihon 1 soat 55 daqiqa davom etadi. Og‘zaki imtihondan oldin sizda 20 daqiqa tayyorgarlik vaqti bo‘ladi.",
  telc_booking_info_written_title: "Yozma imtihon",
  telc_booking_info_written_overview: "Yozma imtihon tinglash, o‘qish/til elementlari va yozma vazifalarni o‘z ichiga oladi.",
  telc_booking_info_written_listening: "Tinglash – 25 min",
  telc_booking_info_written_reading: "O‘qish / Til elementlari – 60 min",
  telc_booking_info_written_writing: "Yozma imtihon – 45 min",
  telc_booking_info_oral_title: "Og‘zaki imtihon",
  telc_booking_info_oral_overview: "Og‘zaki imtihon qisqa tayyorgarlikdan so‘ng o‘tkaziladi va odatda boshqa nomzod bilan birga bo‘ladi.",
  telc_booking_info_oral_preparation: "Tayyorgarlik vaqti – 20 min",
  telc_booking_info_oral_exam: "Og‘zaki imtihon odatda boshqa nomzod bilan",
  ...
  telc_booking_preparation_bullet_5: "Kurs kichik guruhlarda o‘tkaziladi, bu shaxsiy e’tibor berish imkonini beradi",
  telc_booking_preparation_bullet_6: "TELC imtihonining barcha sohalari o‘qitiladi va mashq qilinadi",
  telc_booking_preparation_bullet_7: "Siz TELC amaliy testlari (TELC model testlari) bilan ishlaysiz",
  telc_booking_preparatory_course_contact_prompt: "TELC German B1-B2 Pflege imtihoniga tayyorlanishni xohlaysizmi? Unda biz bilan bog‘laning:",
  telc_booking_faq_intro: "Sizning savollaringiz – bizning javoblarimiz",
  telc_booking_faq_link_text: "Sizda telc imtihoni \u201etelc Deutsch B1-B2 Pflege\u201c bo‘yicha savollar bormi? Quyidagi",
  telc_booking_faq_link_label: "Havola",
  ...
  international_recognition_desc:
    "Bizning sertifikatlarimiz xalqaro miqyosda tan olingan va o'qish hamda ish uchun foydalanish mumkin.",
  modern_methods_desc: "Biz samarali til o'rganish uchun eng yangi o'qitish usullari va materiallaridan foydalanamiz.",
  qualified_teachers_desc: "Bizning o'qituvchilarimiz yuqori malakali va til o'qitishda ko'p yillik tajribaga ega.",
  small_learning_groups_desc: "Kichik guruhlar shaxsiy e'tibor va tezroq o'rganish imkonini beradi.",
  career_prospects_desc: "Nemis tilini bilish Germaniya va butun dunyoda yangi karyera imkoniyatlarini ochadi.",
  ...
  contact_questions:
    "Kurslarimiz haqida savollaringiz bormi yoki ro'yxatdan o'tmoqchimisiz? Bugun biz bilan bog'laning.",
  send_message: "Bizga xabar yuboring",
  name: "Ism",
  ...
  monday_friday: "Dushanba - Juma: 9:00 - 18:00",
  ...
  // Footer
  about_us:
    "O'zbekistonda til ta'limi bo'yicha hamkoringiz. Biz nemis, o'zbek, ingliz va rus tillarida kurslar taklif etamiz.",
  links: "Havolalar",
  ...
  // Photo Gallery
  photo_gallery_title: "Til markazimizdan taassurotlar",
  ...
  // Language detection
  language_detected:
    "Biz sahifani avtomatik ravishda brauzeringiz tilida ko'rsatdik. Tilni istalgan vaqtda o'zgartirishingiz mumkin.",
  dismiss: "Yopish",
