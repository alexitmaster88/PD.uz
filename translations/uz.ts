const uz = {
  ...
  telc_a2_level: "TELC A2 darajasi uchun",
  telc_a2_b1_level: "TELC A2/B1 darajasi uchun",
  telc_b1_level: "TELC B1 darajasi uchun",
  telc_b2_level: "TELC B2 darajasi uchun",
  telc_prep_title: "TELC imtihoniga tayyorgarlik",
  telc_prep_duration: "Kurs davomiyligi — 2 oy",
  telc_prep_lesson_time: "Har bir dars — 2 soat 15 daqiqa",
  telc_prep_small_groups: "Kichik guruhlar — maksimal 10 nafar o'quvchi",
  telc_prep_practice: "TELC imtihoni formatiga mos amaliy mashqlar",
  telc_prep_materials: "Barcha o'quv materiallari kurs narxiga kiritilgan",
