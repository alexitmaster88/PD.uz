const en = {
  ...
  telc_a2_level: "For TELC A2 level",
  telc_a2_b1_level: "For TELC A2/B1 level",
  telc_b1_level: "For TELC B1 level",
  telc_b2_level: "For TELC B2 level",
  telc_prep_title: "TELC Exam Preparation",
  telc_prep_duration: "Course duration — 2 months",
  telc_prep_lesson_time: "Each lesson — 2 hours 15 minutes",
  telc_prep_small_groups: "Small groups — maximum 10 students",
  telc_prep_practice: "Practice exercises matching TELC exam format",
  telc_prep_materials: "All learning materials included in course price",
