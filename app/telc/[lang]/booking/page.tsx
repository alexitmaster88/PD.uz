...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    step3T: "Take the Exam", step3D: "Arrive 60 minutes early with your passport and printed confirmation.",
    ...
    req4: "Arrive 60 minutes before the exam",
  ...
  de: {
    ...
    step3T: "Prüfung ablegen", step3D: "Kommen Sie 60 Minuten früher mit Reisepass und Bestätigung.",
    ...
    req3: "Zahlungsbeleg",
    req4: "60 Minuten vor Prüfungsbeginn erscheinen",
  ...
  ru: {
    ...
    step3T: "Сдайте экзамен", step3D: "Придите за 60 минут до начала с паспортом и распечатанным подтверждением.",
    ...
    req4: "Прийти за 60 минут до начала экзамена",
  ...
  uz: {
    ...
    step3T: "Imtihon topshing", step3D: "Pasport va chop etilgan tasdiqnoma bilan 60 daqiqa oldin keling.",
    ...
    req3: "To'lov cheki",
    req4: "Imtihon boshlanishidan 60 daqiqa oldin keling",
