        ...
        <div className="container mx-auto px-4">
          <div className="backdrop-blur-md bg-white/30 rounded-2xl p-8 mb-12 shadow-lg">
            <div className="text-center mb-8">
              ...
              {/* <p className="text-xl font-semibold text-primary mb-4">{t("welcome_center_tagline")}</p> */}
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">{t("welcome_center_description")}</p>
            </div>
          </div>
          <YouTubePlayer
            videoId="HCRdpfCYxFM"
