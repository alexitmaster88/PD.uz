    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
      <div className="container flex h-16 items-center justify-between">
            ...
            <div className="relative">
              ...
              {isLanguageMenuOpen && (
                <div className="absolute right-0 mt-2 w-32 bg-background rounded-md shadow-lg overflow-hidden z-50 language-menu-container">
                  <div className="py-1">
                    {[
                      { code: "de", name: "Deutsch", flag: "/images/flag-de.png" },
                      { code: "en", name: "English", flag: "/images/flag-en.png" },
                      { code: "ru", name: "Русский", flag: "/images/flag-ru.png" },
                      { code: "uz", name: "O'zbekcha", flag: "/images/flag-uz.png" },
                    ].map((lang) => (
                      <button
                        key={lang.code}
        ...
        <div className="flex items-center gap-4 md:hidden">
          ...
          <button onClick={() => setIsMenuOpen(!isMenuOpen)} aria-label={isMenuOpen ? "Menü schließen" : "Menü öffnen"}>
