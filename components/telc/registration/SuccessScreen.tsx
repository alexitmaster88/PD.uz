...
const ui: Record<string, Record<string, string>> = {
  en: {
    ...
    reminders: "Reminders",
    r1: "Arrive 60 minutes before the exam",
    ...
    tgReminderMsg: "If you chose to send your payment receipt via Telegram, please do so within 24 hours. Otherwise, your registration and reserved exam place may be canceled.",
  ...
  de: {
    ...
    r1: "Kommen Sie 60 Minuten vor der Prüfung",
    ...
    tgReminderMsg: "Wenn Sie Ihren Zahlungsbeleg über Telegram senden möchten, tun Sie dies bitte innerhalb von 24 Stunden. Andernfalls können Ihre Anmeldung und der reservierte Prüfungsplatz storniert werden.",
  ...
  ru: {
    ...
    r1: "Приходите за 60 минут до экзамена",
    r2: "Возьмите паспорт или удостоверение личности (оригинал)",
    r3: "Опоздавших не допускают",
    r4: "Распечатайте это подтверждение (PDF) с квитанцией об оплате и возьмите его с собой",
    ...
    tgReminderMsg: "Если вы выбрали отправку чека через Telegram, пожалуйста, сделайте это в течение 24 часов. В противном случае ваша регистрация и забронированное место могут быть отменены.",
  ...
  uz: {
    ...
    r1: "Imtihonga 60 daqiqa oldin keling",
    ...
    tgReminderMsg: "Agar to'lov chekini Telegram orqali yuborishni tanlaган bo'lsangiz, buni 24 soat ichida bajaring. Aks holda ro'yxatdan o'tish va band qilingan imtihon o'rni bekor qilinishi mumkin.",
